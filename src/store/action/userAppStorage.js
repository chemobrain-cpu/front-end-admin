...
export const checkIfAdminIsLoggedIn = () => {
  return async (dispatch, getState) => {
    try {
      ...
      response = await fetch(`https://back-end-f3qo.onrender.com/adminbytoken`, {
        method: "GET",
        headers:{
...
export const loginAdmin = (data) => {
  ...
  return async (dispatch, getState) => {
    try {
      let response = await fetch('https://back-end-f3qo.onrender.com/adminlogin', {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export const signupAdmin = (data) => {
  ...
  return async (dispatch, getState) => {
    try {
      let response = await fetch(`https://back-end-f3qo.onrender.com/adminsignup`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export const fetchUsers = ()=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch('https://back-end-f3qo.onrender.com/users', {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const deleteUser = (id)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://back-end-f3qo.onrender.com/users/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const fetchDeposits = ()=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://back-end-f3qo.onrender.com/deposits`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const deleteDeposit = (id)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://back-end-f3qo.onrender.com/deposits/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const updateDeposit = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://back-end-f3qo.onrender.com/deposits/${data._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const fetchWithdraws = ()=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://back-end-f3qo.onrender.com/withdraws`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const deleteWithdraw = (id)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://back-end-f3qo.onrender.com/withdraws/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const updateWithdraw = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://back-end-f3qo.onrender.com/withdraws/${data._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const fetchTransfers = ()=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://back-end-f3qo.onrender.com/transfers`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const deleteTransfer = (id)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://back-end-f3qo.onrender.com/trades/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const updateTransfer = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://back-end-f3qo.onrender.com/transfers/${data._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const createTransfer = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://back-end-f3qo.onrender.com/trades`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const updateAdmin = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://back-end-f3qo.onrender.com/admin/${data._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const sendEmail = (data,id)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://back-end-f3qo.onrender.com/sendemail`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
